...
The code provided in the `lib` and `spec` directory is an example of the code a student would build for a passing paired assessment for *Groomer* and *Day Care*. We strongly recommend working through the practice assessment on your own first before checking your work against the example. And remember, the example code is just ONE WAY to solve the problem.
